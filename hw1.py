...
######################################################################
def hawkid():
    return(["Sam Manfield", "sjmansfield"])
...
# Getting inputs
mode = input('Enter either "min", "max", or "avg"')
count = float(input('Enter the number of values you will enter'))
values = list(map(float, input('Enter a list of values').split()))
